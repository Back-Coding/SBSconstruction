...
export default function ExtraFastServise(props) {
 ...
 <>     
   ...
   {isOpenPop &&<div id="defaultModal" tabIndex="-1" aria-hidden="true" className=" fixed top-44 md:mb-4 left-0 right-0 z-50 flex  justify-center w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(75%-1rem)] max-h-full">
    ...
    <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
      ...
      <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-zip" type="number" placeholder="90210" name="pincode" value={data.pincode} onChange={change} minLength={4} required/>
    </div>
        </div>
