        ...
        <form className="w-full max-w-lg" onSubmit={userWorkFormSubmit}>
            ...
            <div className="flex flex-wrap -mx-3 mb-2">
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input className="appearance-none  w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Jane Doe"  name="name" value={data.name} onChange={change} minLength={5} required/>
            ...
            <div className="flex flex-wrap -mx-3 mb-2">
              <div className="w-full px-3">
                ...
                <input type="email" className="appearance-none  w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-eamils" placeholder="exmple@gmail.com"  name="email" value={data.email} onChange={change} required/>
              </div>
            </div>
            <div className="flex flex-wrap -mx-3 mb-2">
              <div className="w-full px-3">
